...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const langButtons = {
        ...
        'ca-mobile': document.getElementById('lang-ca-mobile'),
        'es-mobile': document.getElementById('lang-es-mobile'),
        'en-mobile': document.getElementById('lang-en-mobile'),
    };
    ...
    Object.keys(langButtons).forEach(key => {
        const lang = key.split('-')[0]; // Extreure 'ca', 'es', 'en'
        const btn = langButtons[key];
        if (btn) {
